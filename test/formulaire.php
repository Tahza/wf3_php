...
<body>
  <?php
    ...
    if (!$query = $db->query('SELECT pokemon.id, nom_proprietaire, nom, experience, vie, defense, attaque, experience FROM pokedex INNER JOIN pokemon ON pokedex.id = pokemon.id_pokedex')) {
      $errors[] = "Erreur lors de la création de la requête";
    }
    $table = "";
